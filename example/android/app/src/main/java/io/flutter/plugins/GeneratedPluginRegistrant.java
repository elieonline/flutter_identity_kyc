...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.flutter_identity_kyc.FlutterIdentityKycPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_identity_kyc, com.flutter_identity_kyc.FlutterIdentityKycPlugin", e);
    }
    try {
